export const PROJECT_TYPES = {
  ...
  education: { ru: 'Образование', en: 'Education', he: 'חינוך', category: 'app' },
...
export const PROJECTS = [
  ...
  { slug: 'web-studio', name: 'Web Studio', link: 'https://web-studio-contacts.netlify.app', typeKey: 'personal', tags: ['Portfolio', 'Contacts', 'Lead Form'], desc: { ru: 'Сайт веб-студии: услуги, портфолио и форма контакта.', en: 'Web studio site: services, portfolio and contact flow.', he: 'אתר סטודיו ווב: שירותים, תיק עבודות וטופס יצירת קשר.' } },
  ...
  { slug: 'filip-veksler', name: 'Filip Veksler', link: 'https://filipvekslerpage.netlify.app', typeKey: 'personal', tags: ['Personal Brand', 'Consulting', 'Landing'], desc: { ru: 'Персональный сайт учёного, преподавателя и консультанта.', en: 'Personal site of a scientist, educator and consultant.', he: 'אתר אישי של מדען, מחנך ויועץ.' } },
  ...
  { slug: 'djbeckerman-2', name: 'DJ Beckerman', link: 'https://djbeckerman.vercel.app/', typeKey: 'music', tags: ['Events', 'Audio', 'Booking'], desc: { ru: 'Сайт диджея: афиша, миксы и бронирование выступлений.', en: 'DJ website: events, mixes and performance booking.', he: "אתר די-ג'יי: אירועים, מיקסים והזמנות." } },
];
